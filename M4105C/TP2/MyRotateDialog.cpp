...
:wxDialog(parent, id, wxT("Rotation"), pos, size)
{
 ...
 // Move(wxDefaultPosition);
  ...
  RadioBox1 = new wxRadioBox(this, wxID_ANY, _("Rotation angle"), wxPoint(16,8), wxSize(175,100), 3, __wxRadioBoxChoices_1, 3, 0, wxDefaultValidator, _T("ID_RADIOBOX1"));
